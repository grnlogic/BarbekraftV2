      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <header className="mb-12 text-center">
            <Link to="/" className="inline-flex items-center text-indigo-600 mb-6 hover:underline">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
              Kembali ke Beranda
            </Link>
            <h1 className="text-4xl font-bold mb-4 text-slate-800">Data Statistik Pengelolaan Sampah</h1>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Data berikut menampilkan capaian kinerja pengelolaan sampah dari 315 Kabupaten/kota di Indonesia pada tahun 2024
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              <h3 className="text-xl font-semibold mb-2 text-slate-800">Total Timbulan Sampah</h3>
              <p className="text-3xl font-bold text-orange-500">33.980.337,81</p>
              <p className="text-gray-500">ton/tahun</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              <h3 className="text-xl font-semibold mb-2 text-slate-800">Sampah Terkelola</h3>
              <p className="text-3xl font-bold text-emerald-500">59,83%</p>
              <p className="text-gray-500">20.331.778,78 ton/tahun</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              <h3 className="text-xl font-semibold mb-2 text-slate-800">Sampah Tidak Terkelola</h3>
          ...
          <div className="space-y-10">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="p-6 pb-2">
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Tren Timbulan Sampah Tahunan</h3>
                <p className="text-slate-500">Peningkatan total timbulan sampah di Indonesia dari tahun ke tahun</p>
              </div>
              <div className="p-4">
                <WasteDataChart 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="p-6 pb-2">
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Tren Pengelolaan Sampah</h3>
                <p className="text-slate-500">Peningkatan jumlah sampah terkelola di Indonesia</p>
              </div>
              <div className="p-4">
                <WasteDataChart 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="p-6 pb-2">
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Tren Pengurangan Sampah</h3>
                <p className="text-slate-500">Peningkatan jumlah sampah yang berhasil dikurangi</p>
              </div>
              <div className="p-4">
                <WasteDataChart 
          ...
          <div className="mt-16 text-center">
            <h3 className="text-2xl font-bold mb-4 text-slate-800">Mari Jadilah Bagian dari Solusi!</h3>
            <p className="text-lg text-slate-600 mb-8">
              40,17% sampah di Indonesia masih tidak terkelola. Dengan mendaur ulang dan menggunakan kembali barang bekas, 
              kita bisa membantu mengurangi jumlah sampah yang berakhir di tempat pembuangan.
            </p>
            <Link 
              to="/" 
